...
/* ══ 1 · OS 28 ATRIBUTOS DE GESTO VIVOS ══════════════════════════════════════════════════════
   ...
   leitura de cada um. */
const GESTOS = [   /* 28 vivos; os 2 mortos estao explicados abaixo da lista */
...
checar('os 28 gestos vivos da aba continuam sendo EMITIDOS', semEmissor.length === 0,
...
console.log('contrato do Meu funil: ' + ok + ' checagens — os 28 gestos, os 12 motores e as 11 listas de regra seguem de pé.');
