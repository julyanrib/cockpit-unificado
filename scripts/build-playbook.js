...
const PAGINAS = [
  ...
  { arquivo: 'playbook-dark-kitchen.md', id: 'dark-kitchen', categoria: 'Módulos que viram receita', icone: '◐', titulo: 'Dark Kitchen', resumo: 'Marcas virtuais sobre a mesma cozinha: faturamento novo sobre custo fixo pago.' },
  { arquivo: 'playbook-rota-inteligente.md', id: 'rota-inteligente', categoria: 'Módulos que viram receita', icone: '⇉', titulo: 'Rota Inteligente', resumo: 'O elo que falta no delivery próprio: agrupar e sequenciar a rota do entregador.' },
  { arquivo: 'playbook-conciliacao-ofx.md', id: 'conciliacao-ofx', categoria: 'Módulos que viram receita', icone: '⊞', titulo: 'Conciliação Bancária OFX', resumo: 'O extrato do banco conversando com o caixa: o mês deixa de fechar por aproximação.' },
  { arquivo: 'playbook-multilojas.md', id: 'multilojas', categoria: 'Módulos que viram receita', icone: '⧉', titulo: 'Multilojas / Franqueadora', resumo: 'R$ 29 é preço de decisão automática — e o gancho natural do Enterprise.' },
  ...
  { marker: 'CLIENTES X MRR', id: 'clientes-mrr', categoria: 'Carteira e retenção', icone: '△', titulo: 'Volume × valor: a conta da sua carteira', resumo: 'Território, mancha de bairro, MRR alvo e blindagem da receita recorrente.' },
