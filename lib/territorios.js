...
const TERRITORIOS = [
  ...
  { owner: 'pendente_scaetano', nome: 'Sérgio Caetano', praca: 'SP · Zona Norte e Lapa', cidade: SAOPAULO,
...
const CENTROS_DE_ZONA = [
  ...
  { owner: 'pendente_andregomes', nome: 'André Gomes', cidade: RIO, lat: -22.9500, lng: -43.1830 },
  { owner: 'pendente_luizpimentel', nome: 'Luiz Pimentel', cidade: RIO, lat: -22.8420, lng: -43.2790 },
  ...
  { owner: 'pendente_renatapessoa', nome: 'Renata Pessoa', cidade: SAOPAULO, lat: -23.5500, lng: -46.5900 },
  { owner: 'pendente_scaetano', nome: 'Sérgio Caetano', cidade: SAOPAULO, lat: -23.5020, lng: -46.6250 }
];
...
const ZONAS_ESCRITAS = [
  { marca: ['(zona norte)', '(z norte)'], owner: 'pendente_scaetano', nome: 'Sérgio Caetano' },
  { marca: ['(zona leste)', '(z leste)'], owner: 'pendente_renatapessoa', nome: 'Renata Pessoa' },
...
module.exports = { TERRITORIOS, CENTROS_DE_ZONA, ZONAS_ESCRITAS, rotearTerritorio, regraDoTerritorio, donoPorProximidade, donoPorZonaEscrita, kmEntre, semAcento };
